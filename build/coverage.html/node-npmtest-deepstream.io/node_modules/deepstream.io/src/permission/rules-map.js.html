...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-deepstream.io/node_modules/deepstream.io/src/permission/rules-map.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-deepstream.io/node_modules/deepstream.io/src/permission/rules-map.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-deepstream.io/node_modules/deepstream.io/src/permission/</a> &#187; rules-map.js</div>
</div>
<div class="body">
 ...
 */
exports.getRulesForMessage = <span class="fstat-no" title="function not covered" >function (message) {</span>
<span class="cstat-no" title="statement not covered" >  if (RULES_MAP[message.topic] === undefined) {</span>
<span class="cstat-no" title="statement not covered" >    return null</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (RULES_MAP[message.topic].actions[message.action] === undefined) {</span>
<span class="cstat-no" title="statement not covered" >    return null</span>
  }
&nbsp;
 ...
 * @returns {Boolean}
 */
exports.supportsData = <span class="fstat-no" title="function not covered" >function (type) {</span>
<span class="cstat-no" title="statement not covered" >  return RULE_TYPES[type.toUpperCase()].data</span>
}
&nbsp;
/**
 ...
 * @returns {Boolean}
 */
exports.supportsOldData = <span class="fstat-no" title="function not covered" >function (type) {</span>
<span class="cstat-no" title="statement not covered" >  return RULE_TYPES[type.toUpperCase()].oldData</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
